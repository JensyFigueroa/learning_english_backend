const RegularVerbs = require("../models/regularverbs.js");
const Pet = require("../models/pet.js");

const getRegularVerbs = async (req, res) => {
  // res.send('Here getRegularVerbs')
  try {
    const arrayVerbsDB = await RegularVerbs.find();
    //console.log(arrayRegularVerbsDB)
     res.send(arrayVerbsDB)
